...
export default function NewTicket({ activeTab }) {
    ...
    const getTicket = () => {
        setLoading(true);
        axios.get(`${ipaddress}changeMangement/getAllTickets?cid=${companyid}&bid=${branchId}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
                            ...
                            <hr className="my-2" style={{ borderTop: "1px solid #ccc" }} />
                                                ...
                                                <div className="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        {/* Attach File Button */}
                                                        <label htmlFor="attachment2" style={{ fontSize: 14 }} className="btn btn-outline-secondary">
                                                            📎 Attach File
                                                        </label>
