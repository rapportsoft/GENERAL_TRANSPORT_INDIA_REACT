...
export default function PendingApprovals({ activeTab }) {
    ...
    const handleSave = () => {
        ...
        setLoading(true);
        axios.post(`${ipaddress}changeMangement/approveTicket`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const getTicket = () => {
        setLoading(true);
        axios.get(`${ipaddress}changeMangement/getPendingTicketData?cid=${companyid}&bid=${branchId}&id=${userId}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
                            ...
                            <hr className="my-2" style={{ borderTop: "1px solid #ccc" }} />
                                                ...
                                                <div className="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        {/* Attach File Button */}
                                                        <label htmlFor="attachment1" style={{ fontSize: 14 }} className="btn btn-outline-secondary">
                                                            📎 Attach File
                                                        </label>
