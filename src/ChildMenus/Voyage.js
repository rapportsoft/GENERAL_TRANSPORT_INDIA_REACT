...
export default function Voyage() {
    ...
    const addVoyage = () => {
        navigate(`/master/addvoyage`, { state: { flag: "add" } });
    }
                ...
                <Card style={{ backgroundColor: "#F8F8F8" }}>
                    <CardBody>
                        <Row className="text-end">
                            <Col>
                                <Button type="button" className="btn btn-outline-primary btn-margin newButton" onClick={addVoyage} variant="outline-primary" style={{ marginTop: '0px', marginRight: 15 }}>
                        ...
                        <Row>
                            <Col md={4}>
                                <Label style={{ fontSize: '14px' }} className="forlabel" for="exBondingId">Voyage No</Label>
                                <Input
                                    type="text"
                                    name="gateInId"
                                    id="gateInId"
                            ...
                            <Col md={4}>
                                <Label style={{ fontSize: '14px' }} className="forlabel" for="exBondingId">Port Of Call</Label>
                                <Input
                                    type="text"
                                    name="gateInId"
                                    id="gateInId"
