...
export default function BondSSRActivity({ acttab }) {
    ...
    const handleSave = () => {
        setLoading(true);
        if (!ssrDtl.nocNo) {
            toast.error("NOC No is required.", {
                autoClose: 800
            })
            setLoading(false);
            return;
        ...
        axios.post(`${ipaddress}ssr/saveBondNOCSSR?cid=${companyid}&bid=${branchId}&user=${userId}&type=${selectedInvoice}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                ...
                if (data.ssr[15] === "NOC") {
                    setSsrDtl({
                        ...
                        branchId: "",
                        transId: data.ssr[2] || "",
                        erpDocRefNo: data.ssr[3] || "",
                        docRefNo: data.ssr[4] || "",
                        containerNo: "",
                        profitcentreId: "",
                        serviceId: "",
                        transLineNo: null,   // BigDecimal
                        transDate: data.ssr[9] === null ? null : new Date(data.ssr[9]),     // Date (You can use null for dates)
                        ssrRefNo: "",
                        docRefDate: data.ssr[10] === null ? null : new Date(data.ssr[10]),    // Date
                        igmLineNo: data.ssr[11] || "",
                        beNo: data.ssr[12] || "",
                        beDate: data.ssr[13] === null ? null : new Date(data.ssr[13]),        // Date
                        noOfPackages: 0,     // int
                        cargoWt: null,       // BigDecimal
                        gateOutType: "",
                        containerInvoiceType: "",
                        commodityDescription: data.ssr[14] || "",
                        impId: "",
                        sl: "",
                        sa: "",
                        cha: data.ssr[16] || "",
                        accId: data.ssr[17] || "",
                        ssrModeFor: data.ssr[18] || "",
                        srlNo: null,         // BigDecimal
                        serviceUnit: "",
                        executionUnit: "",
                        serviceUnit1: "",
                        ...
                        rate: null,          // BigDecimal
                        totalRate: null,     // BigDecimal
                        status: data.ssr[19] || "",        // char, defaulting to empty string
                        createdBy: data.ssr[20] || "",
                        createdDate: null,   // Date
                        editedBy: "",
                        editedDate: null,    // Date
                        approvedBy: "",
                        ...
                        ssrPartyId: "",
                        nocNo: data.ssr[5] || "",
                        nocDate: data.ssr[6] === null ? null : new Date(data.ssr[6]),
                        inBondId: data.ssr[7] || "",
                        inBondDate: data.ssr[8] === null ? null : new Date(data.ssr[8]),
                        exBondId: "",
                        exBondDate: null,
                        exBondBeId: "",
                        exBondBeDate: null
                    ...
                    setSsrDtl({
                        ...
                        inBondDate: null,
                        exBondId: data.ssr[7] || "",
                        exBondDate: data.ssr[8] === null ? null : new Date(data.ssr[8]),
                        exBondBeId: data.ssr[21] || "",
                        exBondBeDate: data.ssr[22] === null ? null : new Date(data.ssr[22]),
                    });
                }



                setSelectedInvoice(data.ssr[15])
    ...
    const search = (val) => {
        ...
        axios.get(`${ipaddress}ssr/searchBondSSR?cid=${companyid}&bid=${branchId}&val=${val}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const getDataByTransId = (trans, sb) => {
        setLoading(true);
        axios.get(`${ipaddress}ssr/getBondDataByTransId?cid=${companyid}&bid=${branchId}&transid=${trans}&type=${sb}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handleExBondBoeSearchChange = async (selectedOption, { action }) => {
        ...
        if (action === 'clear') {
            ...
            getSelectedExbondData(selectedOption.value);
        }
    };


    const getSelectedExbondData = (id) => {
        axios.get(`${ipaddress}ssr/getDataForExbondSSR?cid=${companyid}&bid=${branchId}&boe=${id}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                ...
                setSsrDtl({
                    ...
                    docRefNo: data[4] || "",
                    containerNo: "",
                    profitcentreId: data[1] || "",
                    serviceId: "",
                    transLineNo: null,   // BigDecimal
                    transDate: new Date(),     // Date (You can use null for dates)
                    ssrRefNo: "",
                    docRefDate: data[6] === null ? null : new Date(data[6]),    // Date
                    igmLineNo: data[5] || "",
                    beNo: data[14] || "",
                    beDate: data[15] === null ? null : new Date(data[15]),        // Date
                    noOfPackages: 0,     // int
                    cargoWt: null,       // BigDecimal
                    gateOutType: "",
                    containerInvoiceType: "",
                    commodityDescription: data[11] || "",
                    impId: "",
                    sl: "",
                    sa: "",
                    cha: data[8] || "",
                    ...
                    ssrPartyId: "",
                    nocNo: data[2] || "",
                    nocDate: data[3] === null ? null : new Date(data[3]),
                    inBondId: "",
                    inBondDate: null,
                    exBondId: data[12] || "",
                    exBondDate: data[13] === null ? null : new Date(data[13]),
                    exBondBeId: data[16] || "",
                    exBondBeDate: data[17] === null ? null : new Date(data[17]),
                })
    ...
    const handleSearchChange = async (selectedOption, { action }) => {
        ...
        if (action === 'clear') {
            ...
            getSelectedNocData(selectedOption.nocTransId, selectedOption.value);
        }
    };


    const getSelectedNocData = (trans, id) => {
        axios.get(`${ipaddress}ssr/getDataForNOCSSR?cid=${companyid}&bid=${branchId}&trans=${trans}&boe=${id}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                ...
                setSsrDtl({
                    ...
                    nocDate: data[3] === null ? null : new Date(data[3]),
                    inBondId: data[12] || "",
                    inBondDate: data[13] === null ? null : new Date(data[13]),
                    exBondId: "",
                    exBondDate: null,
                    exBondBeId: "",
                    exBondBeDate: null
                        ...
                        <table className="table table-bordered table-hover tableHeader">
                            <thead className='tableHeader'>
                                <tr>
                                    ...
                                    <th scope="col">In Bond Id</th>
                                    <th scope="col">Ex Bond Id</th>
                                    <th scope="col">SSR Type</th>
                                </tr>
                            </thead>
                            <tbody>
                                {currentItems.map((item, index) => (
                                    <tr key={index}>
                                        <td>
                                            <input type="radio" onChange={() => getDataByTransId(item[0], item[8])} name="radioGroup" />
                                        </td>
                                        <td>{item[0]}</td>
                                        <td>{item[2]}</td>
                                        <td>{item[3]}</td>
