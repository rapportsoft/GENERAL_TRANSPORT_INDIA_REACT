...
export default function BondInventoryReport() {
    ...
    useEffect(() => {
        setEndDate(new Date()); // Set end date to current date and time
      }, []);
      ...
      const handleShow = async (type) => {
        try {
          if (! endDate)
          {
            ...
            const response = await axios.get(
                `${ipaddress}api/bondingReport/show?companyId=${companyid}&branchId=${branchId}&uname=${username}&type=${type}&cname=${companyname}&bname=${branchname}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`,
                {
                    headers: {
                        Authorization: `Bearer ${jwtToken}`
                    }
...
<div>
        ...
        <table className="table table-bordered table-hover tableHeader">
            <thead className="text-center">
                <tr>
                    ...
                    <th scope="col">Inbonded Boe No</th>
                    <th scope="col">Inbonded Boe Date</th>
                    <th scope="col">Section 49</th>
                    <th scope="col">Section 60(1)</th>
                    <th scope="col">Inbond Pkgs</th>
                    ...
                    <th scope="col">Bal Asset Value</th>
                    <th scope="col">Bal Duty Value</th>
                    <th scope="col">Area Balance Area</th>
    ...
    <td><input  style={{ 
                ...
                outline: 'none', 
                boxShadow: 'none' 
            }}  value={index + 1} readOnly /></td> {/* Sr No */}
    <td>
        <input 
            style={{ 
                width: '100px', 
    ...
    <td>
        <input 
            ...
            value={item.nocDate ? format(new Date(item.nocDate), 'dd/MM/yyyy') : ""} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '120px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.inBondingDate ? format(new Date(item.inBondingDate), 'dd/MM/yyyy HH:mm') : ""} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '54px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.igmNo || ""} 
        />
    </td>
    <td>
    ...
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.boeDate ? format(new Date(item.boeDate), 'dd/MM/yyyy') : ""} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '81px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.section49 || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '81px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.section60_1 || ""} 
        /> {/* Fixed the property name */}
    </td>
    <td>
        <input 
            style={{ width: '72px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.inBondedPackagesDtl || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.inbondGrossWtDtl || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.inbondCifValue || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.inbondCargoDuty || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '270px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.commodityDescription || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '450px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.cha || ""} 
        />
    </td>
    <td>
    ...
    <td>
        <input 
            style={{ width: '150px', border: 'none', outline: 'none', boxShadow: 'none' }} 
    ...
    <td>
        <input 
            style={{ width: '81px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={(item.inBondedPackagesDtl || 0) - (item.exBondedPackagesDtl || 0)} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '99px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={(item.inbondGrossWtDtl || 0) - (item.exbondGrossWtDtl || 0)} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={(item.inbondCifValue || 0) - (item.exbondCifValue || 0)} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={(item.inbondCargoDuty || 0) - (item.exbondCargoDuty || 0)} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={(item.areaOccupied || 0) - (item.areaRelesed || 0)} 
            readOnly 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.bondingNo || ""} 
        />
    </td>
    <td>
        <input 
            style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
            value={item.bondingDate ? format(new Date(item.bondingDate), 'dd/MM/yyyy') : ""} 
            readOnly 
        />
    </td>
</tr>
