...
import ImportGateOut from './ImportGateOut';
import {
    Row,
    Col,
    Input,
...
import IGMEntry from './IGMEntry';
import { toast } from 'react-toastify';
import GateIn from './GateIn';
import SealCutting from './SealCutting';
import Examination from './Examination';
import Destuff from './Destuff';
import ImportGatePass from './ImportGatePass';
import { CSSTransition } from 'react-transition-group';
import "../Components/RowAnimation.css"
import CargoExamination from './CargoExamination';
import ManualContainerGateIn from './ManualContainerGateIn';
import ImportHold from './ImportHold';
import UploadIgm from '../Document Upload/UploadIgm';
import SSRActivity from './SSRActivity';
import ContainerEirUpload from './ContainerEirUpload';
import WaiverEntry from './WaiverEntry'
import ReScanGateOut from './ReScanGateOut';
import ReScanGateIn from './ReScanGateIn';
import ImportSpecialDelivery from './ImportSpecialDelivery';
import ImportContainerHistory from './ImportContainerHistory';
                ...
                <Card style={{ backgroundColor: "#F8F8F8" }}>
                    <CardBody>
                        ...
                        <Row>
                            ...
                            >
                                <div className={`tab-pane fade ${activeTab === 'P00201' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                    <UploadIgm />

                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00202' ? 'show active' : ''}`} id="bordered-justified-profile-2" role="tabpanel" aria-labelledby="2">
                                    <IGMEntry igm={searchIgmTrans} igm1={searchedIgm} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00203' ? 'show active' : ''}`} id="bordered-justified-contact-3" role="tabpanel" aria-labelledby="3">
                                    <GateIn igm={searchedIgm} cont={searchCon} conList={searchConList} process={activeTab} onRequest={hndleRequest} inId={gateInId} igmtrans={searchIgmTrans} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00204' ? 'show active' : ''}`} id="bordered-justified-home-4" role="tabpanel" aria-labelledby="4">
                                    <SealCutting igm={sealcitigm} item={sealcutitem} cont={searchCon} sealStatus={searchSealCutStatus} process={activeTab} onRequest={hndleRequest} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00205' ? 'show active' : ''}`} id="bordered-justified-cargo-exmination" role="tabpanel" aria-labelledby="5">
                                    <Examination igm={sealcitigm} item={sealcutitem} cont={searchCon} sealStatus={searchSealCutStatus} process={activeTab} onRequest={hndleRequest} />

                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00206' ? 'show active' : ''}`} id="bordered-justified-Destuff" role="tabpanel" aria-labelledby="6">


                                    <Destuff igm1={sealcitigm} item1={sealcutitem} cont={searchCon} sealStatus={searchSealCutStatus} process={activeTab} onRequest={hndleRequest} />




                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00208' ? 'show active' : ''}`} id="bordered-justified-Gate Pass" role="tabpanel" aria-labelledby="7">
                                    <ImportGatePass igm={sealcitigm} igmTrans={searchIgmTrans} item={sealcutitem} cont={searchCon} sealStatus={searchSealCutStatus} process={activeTab} onRequest={hndleRequest} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00209' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">

                                    <ImportGateOut igm={sealcitigm} igmTrans={searchIgmTrans} item={sealcutitem} cont={searchCon} sealStatus={searchSealCutStatus} process={activeTab} onRequest={hndleRequest} />

                                </div>


                                <div className={`tab-pane fade ${activeTab === 'P00210' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <CargoExamination igm={sealcitigm} igmTrans={searchIgmTrans} item={sealcutitem} cont={searchCon} sealStatus={searchSealCutStatus} process={activeTab} onRequest={hndleRequest} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00211' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <ImportHold process={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00212' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <ManualContainerGateIn process={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00213' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <SSRActivity process={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00214' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <Row>
                                    ...
                                    <hr />
                                    <h5 className="pageHead" style={{ fontFamily: 'Your-Heading-Font', paddingLeft: '2%', paddingRight: '-50px' }} >
                                        Upload Details </h5>
                                ...
                                <div className={`tab-pane fade ${activeTab === 'P00215' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <ContainerEirUpload />
                                </div>
                                ...
                                <div className={`tab-pane fade ${activeTab === 'P00216' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <WaiverEntry process={activeTab} />
                                </div>

                                <div className={`tab-pane fade ${activeTab === 'P00217' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <ReScanGateOut igm={searchedIgm} cont={searchCon} conList={searchConList} process={activeTab} onRequest={hndleRequest} inId={gateInId} igmtrans={searchIgmTrans} />
                                </div>

                                <div className={`tab-pane fade ${activeTab === 'P00218' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <ReScanGateIn igm={searchedIgm} cont={searchCon} conList={searchConList} process={activeTab} onRequest={hndleRequest} inId={gateInId} igmtrans={searchIgmTrans} />
                                </div>

                                <div className={`tab-pane fade ${activeTab === 'P00219' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="9">
                                    <ImportSpecialDelivery process={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00220' ? 'show active' : ''}`} id="bordered-justified-Gate Out" role="tabpanel" aria-labelledby="8">
                                    <ImportContainerHistory igm={searchedIgm} cont={searchCon} conList={searchConList} process={activeTab} onRequest={hndleRequest} inId={gateInId} igmtrans={searchIgmTrans} />
                                </div>
