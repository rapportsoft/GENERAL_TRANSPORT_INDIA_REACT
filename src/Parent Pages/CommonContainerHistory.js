...
export default function CommonContainerHistory({ activeTab }) {
    ...
    const handleSearch = () => {
        ...
        axios.get(`${ipaddress}cfigm/commonContainerHistory?cid=${companyid}&bid=${branchId}&con=${containerNo}`, {
            headers: {
                    ...
                    <table className="table table-bordered table-hover tableHeader dynamic-table">
                        <thead className="tableHeader">
                            <tr className="table-header">
                                ...
                                <th scope="col" className="text-center">FCL/LCL</th>
                                <th scope="col" className="text-center">Delivery Mode</th>
                                <th scope="col" className="text-center">Agent</th>
                                <th scope="col" className="text-center">Nominated Customer</th>
                                <th scope="col" className="text-center">IGM/ITEM No/INV No/TRNS No</th>
                                <th scope="col" className="text-center">Description</th>
                                <th scope="col" className="text-center">VCN No</th>
                                <th scope="col" className="text-center">Vessel</th>
                                <th scope="col" className="text-center">Process Date</th>
                                <th scope="col" className="text-center">Process By</th>
                                <th scope="col" className="text-center">Current Location</th>
                                <th scope="col" className="text-center">POD</th>
                                <th scope="col" className="text-center">Force Entry Date</th>
