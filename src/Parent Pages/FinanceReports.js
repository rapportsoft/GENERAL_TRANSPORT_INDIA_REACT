...
import ImportOperationalReports from "./ImportOperationalReports";
import ExportOperationalReport from "./ExportOperationalReport";
import FinanceOperationsReport from "./FinanceOperationsReport";
        ...
        <Card style={{ backgroundColor: "#F8F8F8" }}>
          <CardBody>
            ...
            <Row>
              ...
              >
                <div
                  className={`tab-pane fade ${activeTab === "P01301" ? "show active" : ""
                    }`}
                  id="bordered-justified-profile-2"
                  role="tabpanel"
                  aria-labelledby="2"
                >
                  <FinanceOperationsReport />
                </div>
