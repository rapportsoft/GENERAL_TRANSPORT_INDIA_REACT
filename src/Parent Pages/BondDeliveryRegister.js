...
export default function BondDeliveryRegister() {
    ...
    const handleStartDateChange = (date) => {
      ...
      const handleExleDownload = async (type) => {
        try {
          ...
          if (!boeNo && !exBondBeNo && !startDate && !endDate) {
          ...
          const response = await axios.get(
            `${ipaddress}api/bondingReport/bondDeliveryRegister?companyId=${companyid}&branchId=${branchId}&uname=${username}&type=${type}&cname=${companyname}&bname=${branchname}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&boeNo=${boeNo}&exBondBeNo=${exBondBeNo}`,
            {
              headers: {
          ...
          a.href = url;
          a.download = `BondDeliveryRegister.xlsx`;
      ...
      const handleShow = async (type) => {
        try {
          ...
          if (!boeNo && !exBondBeNo && !startDate && !endDate) {
            ...
            const response = await axios.get(
                `${ipaddress}api/bondingReport/showBondDeliveryRegister?companyId=${companyid}&branchId=${branchId}&uname=${username}&type=${type}&cname=${companyname}&bname=${branchname}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&boeNo=${boeNo}&exBondBeNo=${exBondBeNo}`,
                {
                    headers: {
                        Authorization: `Bearer ${jwtToken}`
                    }
      ...
      <FormGroup>
       ...
       Exbond Boe No 
        ...
        <input
          ...
          name="exBondBeNo"
          value={exBondBeNo}
          onChange={(e)=>setExBondBeNo(e.target.value)}
        />
      </FormGroup>
    </Col>
...
<button
    ...
    <thead className="text-center">
        <tr>
            ...
            <th scope="col">Exbond Date</th>
            <th scope="col">Exbond BOE No</th>
            ...
            <th scope="col">Exbond CIF</th>
            <th scope="col">Exbond Duty</th>
        </tr>
    </thead>
    <tbody className="text-center">
        {currentItems.map((item, index) => (
            <tr key={index}>
                <td>
                    <input 
                        style={{ width: '45px', border: 'none', outline: 'none', boxShadow: 'none' }} 
                        value={index + 1} 
                        readOnly 
                    />
                </td>
                <td>
                    <input 
                        ...
                        value={item.exBondingDate ? format(new Date(item.exBondingDate), 'dd/MM/yyyy') : ""} 
                        readOnly 
                    />
                </td>
                <td>
                ...
                <td>
                    <input 
                        style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
                        value={item.bondValidityDate ? format(new Date(item.bondValidityDate), 'dd/MM/yyyy') : ""} 
                        readOnly 
                    />
                </td>
                <td>
                ...
                <td>
                    <input 
                        style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
                        value={item.exBondedPackagesdtl || ""} 
                    />
                </td>
                <td>
                    <input 
                ...
                <td>
                    <input 
                        style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
                        value={item.exBondedGWdtl || ""} 
                    />
                </td>
                <td>
                    <input 
                        style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
                        value={item.exBondedCIFdtl || ""} 
                    />
                </td>
                <td>
                    <input 
                        style={{ width: '100px', border: 'none', outline: 'none', boxShadow: 'none' }} 
                        value={item.exBondedCargoDutydtl || ""} 
                    />
                </td>
            </tr>
        ))}
