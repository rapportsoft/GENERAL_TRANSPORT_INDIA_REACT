...
import EmptyVehicleGateIn from '../Common Pages/EmptyVehicleGateIn';
import EmptyVehicleGateOut from '../Common Pages/EmptyVehicleGateOut';
import { toast } from 'react-toastify';
import EmptyJobOrder from '../Common Pages/EmptyJobOrder';
import EmptyContainerGatePass from '../Common Pages/EmptyContainerGatePass';
import EmptyContainerGateOut from '../Common Pages/EmptyContainerGateOut';
import CommonContainerHistory from './CommonContainerHistory';
...
export default function Common() {
    ...
    const [gateOutId, setGateOutId] = useState('');


    const searchForVehicle = (veh) => {
        setLoading(true);
        if (!veh) {
        ...
        axios.get(`${ipaddress}gateIn/searchByVehicleNo?cid=${companyid}&bid=${branchId}&veh=${veh}`, {
            headers: {
            ...
            .then((response) => {
                ...
                setGateInId(data.gateInId);
                setGateOutId(data.gateOutId);
                setpagesList(data.pageList);
                setActiveTab('');
    ...
    const [activeTab, setActiveTab] = useState('P00601');
                    ...
                    <CardBody>
                        ...
                        >
                            <Row>
                                <Col md={2}>
                                    <FormGroup>
                                        <label className="forlabel" htmlFor="sbRequestId">Vehicle No</label>
                                        <input
                                ...
                                <Col md={2} style={{ marginTop: 24 }}>
                                    <button
                                        ...
                                        onClick={()=>searchForVehicle(searchId)}
                                    >
...
<ul  className="nav nav-tabs nav-tabs-bordered d-flex" id="borderedTabJustified" role="tablist">
    {renderTabs()}
                            ...
                            <div className="tab-content bgScreenStyle" id="borderedTabJustifiedContent">
                                ...
                                <div className={`tab-pane fade ${activeTab === 'P00601' ? 'show active' : ''}`} id="bordered-justified-profile-2" role="tabpanel" aria-labelledby="2">
                                    <EmptyVehicleGateIn activeTab={activeTab} gateInId={gateInId} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00602' ? 'show active' : ''}`} id="bordered-justified-contact-3" role="tabpanel" aria-labelledby="3">
                                    <EmptyVehicleGateOut activeTab={activeTab} gateInId={gateInId} gateOutId={gateOutId} vehicleno={vehicleNo} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00603' ? 'show active' : ''}`} id="bordered-justified-contact-3" role="tabpanel" aria-labelledby="3">
                                    <EmptyJobOrder  activeTab={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00604' ? 'show active' : ''}`} id="bordered-justified-contact-3" role="tabpanel" aria-labelledby="3">
                                    <EmptyContainerGatePass  activeTab={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00605' ? 'show active' : ''}`} id="bordered-justified-contact-3" role="tabpanel" aria-labelledby="3">
                                    <EmptyContainerGateOut  activeTab={activeTab} />
                                </div>
                                <div className={`tab-pane fade ${activeTab === 'P00606' ? 'show active' : ''}`} id="bordered-justified-contact-3" role="tabpanel" aria-labelledby="3">
                                    <CommonContainerHistory activeTab={activeTab} />
                                </div>
                            </div>
