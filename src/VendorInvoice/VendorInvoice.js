...
export default function VendorInvoice() {
    ...
    const getServices = () => {
        axios.get(`${ipaddress}vendorInvoice/getServices?cid=${companyid}&bid=${branchId}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handleSave = () => {
        ...
        axios.post(`${ipaddress}vendorInvoice/saveData?cid=${companyid}&bid=${branchId}&user=${userId}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                ...
                setAssessmentData({
                    ...
                    lastAssesmentId: "",
                    lastAssesmentDate: null,
                    lastInvoiceNo: singleData[53] || "",
                    lastInvoiceDate: singleData[54] === null ? null : new Date(singleData[54])
    ...
    const saveProcess = () => {
        ...
        axios.post(`${ipaddress}vendorInvoice/processData?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                const data = response.data.result;
                const data1 = response.data.existingSrv;
                ...
                setReceiptAmt(data1.invoiceAmt);
    ...
    const searchExportEmptyContainerGateIn = (id) => {
        setLoading(true);
        axios.get(`${ipaddress}vendorInvoice/searchVendorInvoiceData?cid=${companyid}&bid=${branchId}&val=${id}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const getSelectedInvoiceData = (assId, invId) => {
        axios.get(`${ipaddress}vendorInvoice/getSelectedVendorInvoiceData?cid=${companyid}&bid=${branchId}&assId=${assId}&invId=${invId}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handlePrint1 = async (type) => {
        ...
        axios.post(`${ipaddress}miscellaneousInvPrint/vendorInvPrintpdf/${companyid}/${branchId}/${invoiceNo}`, {}, {
            headers: {
                                ...
                                <Row>
                                    <Col md={6}>
                                        ...
                                        >
                                            <img
                                                alt="Sample"
                                                src="https://raw.githubusercontent.com/ShubhamDeshmukh18/AshteLogistics/main/assets/img/testimonials/Invoice01.jpg"
                                            />
                                            <CardBody>
                                                <CardTitle tag="h5">
                                                    Invoice Format 1
                      ...
                      <Input type="radio" name="radio1" style={{ marginLeft: "10px" }} />
                                    ...
                                    <Col md={6}>
                                        ...
                                        >
                                            <img
                                                alt="Sample"
                                                src="https://raw.githubusercontent.com/ShubhamDeshmukh18/AshteLogistics/main/assets/img/testimonials/Invoice02.jpg"
                                            />
                                            <CardBody>
                                                <CardTitle tag="h5">
                                                    Invoice Format 2
                        ...
                        <Col md={2}>
                            <FormGroup>
                                ...
                                <Input
                                    ...
                                    disabled
                                >
                                    <option value="PD">Vendor Billing</option>
                                </Input>
                        ...
                        <Col md={2}>
                            <FormGroup>
                                ...
                                <Input
                                    ...
                                    name='receiptAmt'
                                    value={parseFloat(
                                        serviceData.reduce((total, item) => total + (parseFloat(item.totalRate) || 0), 0).toFixed(3)
                                    )}
                                    disabled
                                />
                        ...
                        <Col md={2}>
                            <FormGroup>
                                ...
                                <Input
                                    ...
                                    id="receiptAmt"
                                    name='receiptAmt'
                                    value={assessmentData.invoiceNo !== '' ? receiptAmt : 0}
                                    disabled
                                />
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td >
                                            <Select
                                                ...
                                                isClearable
                                                isDisabled={assessmentData.invoiceNo !== "" || item.assesmentId !== ""}
                                                id={`serviceId${index}`}
                                                name="serviceId"
                                                className={`autocompleteHeight`}
                                                menuPlacement="top"
                                        ...
                                        <td>
                                            <Input
                                                ...
                                                disabled={item.serviceUnit1 === "NA" || item.serviceUnit1 === "" || assessmentData.invoiceNo !== ""}
                                                onChange={(e) => handleServiceChange(e, index)}
                                            />
                                        </td>
                                        <td>
