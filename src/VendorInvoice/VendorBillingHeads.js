...
export default function VendorBillingHeads() {
    ...
    const getAllServices = async (companyid, branchId) => {
        serviceMaster.getServices(companyid, branchId, jwtToken).then((res) => {
    ...
    const addNewEntry = () => {
        navigate(`/vendor/addBillingHeads`, { state: { flag: "add" } });
    };

    const EditService = (serviceId) => {
        navigate(`/vendor/addBillingHeads`, {
    ...
    const deleteService = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .post(
                        `${ipaddress}apservices/deleteService?companyId=${companyid}&branchId=${branchId}&serviceId=${id}`,
                        null,
                        {
                            headers: {
                            ...
                            <Col md={3}>
                                <div style={{ marginTop: 22 }}>
                                    <Button
                                        color="success"
                                        outline
                                        style={{ marginRight: "5px", fontSize: 12 }}
                                    ...
                                    <Button style={{ fontSize: 12 }} color="danger" outline onClick={handleReset}>
                                        <FontAwesomeIcon
                                            icon={faRefresh}
                                            style={{ marginRight: "5px" }}
                                        />
