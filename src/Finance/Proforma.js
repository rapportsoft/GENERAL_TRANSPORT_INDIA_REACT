...
import ImportProforma from './ImportProforma';
import ExportProforma from './ExportProforma';
                ...
                <Card style={{ backgroundColor: "#F8F8F8" }}>
                    <CardBody>
                        ...
                        <div className="tab-content bgScreenStyle" id="borderedTabJustifiedContent">
                            <div className={`tab-pane fade ${activeTab === 'P01106' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <ImportProforma activeTab={activeTab} />

                            </div>



                            <div className={`tab-pane fade ${activeTab === 'P01107' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <BondProforma activeTab={activeTab} />

                            </div>



                            <div className={`tab-pane fade ${activeTab === 'P01108' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <ExportProforma activeTab={activeTab} />
                            ...
                            <div className={`tab-pane fade ${activeTab === 'P01120' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <GeneralProforma activeTab={activeTab} />
                            ...
                            <div className={`tab-pane fade ${activeTab === 'P01121' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">
