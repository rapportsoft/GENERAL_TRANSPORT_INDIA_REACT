...
export default function General({ activeTab }) {
  ...
  const getCommodityData = () => {
    ...
    axios
      .get(
        `${ipaddress}jardetail/getJarDetail?companyId=${companyid}&jarId=${id}`,
        {
          headers: {
  ...
  const getImpData = (val) => {
    ...
    axios
      .get(
        `${ipaddress}party/getImp?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const getChaData = (val) => {
    ...
    axios
      .get(
        `${ipaddress}party/getChaWithAdd?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const getAccData = (val) => {
    ...
    axios
      .get(
        `${ipaddress}party/getAllWithAdd?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const getFwdData = (val) => {
    ...
    axios
      .get(
        `${ipaddress}party/getForwarder?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const getSearchData = (val) => {
    ...
    axios
      .get(
        `${ipaddress}assessmentgeneral/getSearchDataForReceivingContainerWiseInvoice?cid=${companyid}&bid=${branchId}&id=${val}`,
        // `${ipaddress}assessment/getSearchDataForReceivingContainerWiseInvoice?cid=${companyid}&bid=${branchId}&id=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const handleSearchChange = async (selectedOption, { action }) => {
    if (action === "clear") {
      ...
      getSelectedBeforeSearchData(selectedOption.receivingId);
    }
  };
  ...
  const getSelectedBeforeSearchData = (igmtrans) => {
    ...
    axios
      .get(
        `${ipaddress}assessmentgeneral/getSelectedDataForReceivingContainerWiseInvoice?cid=${companyid}&bid=${branchId}&id=${igmtrans}`,
        // `${ipaddress}assessment/getSelectedDataForReceivingContainerWiseInvoice?cid=${companyid}&bid=${branchId}&id=${igmtrans}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
      ...
      .then((response) => {
        ...
        setAssessmentData({
          ...
          intComments: "",
          impAddress:
            (singleData[10] === null ? "" : singleData[10]) ||
            "" + " - " + (singleData[11] === null ? "" : singleData[11]) ||
            "" + " - " + (singleData[12] === null ? "" : singleData[12]) ||
            "",
          ...
          lastAssesmentId: "",
          lastAssesmentDate: null,
          lastInvoiceNo: singleData[26] || "",
          lastInvoiceDate:
            singleData[27] === null ? null : new Date(singleData[27]),
        });
        ...
        setContainerData(
          data.map((item) => ({
            ...
            checkDate: "N",
            invoiceDate: null,
            lastInvoiceUptoDate: item[25] === null ? null : new Date(item[25]),
            upTariffNo: "",
            profitcentreId: item[1] || "",
            grossWt: item[22] ? (item[22] / 1000).toFixed(3) : "",
            cargoWt: parseFloat(item[23]).toFixed(3) || 0,
            ssrTransId: "",
            serviceId: "",
            serviceName: "",
            rates: "",
            containerStatus: item[20] || "",
            gatePassNo: "",
            gateOutId: "",
            area: parseFloat(item[23]).toFixed(3) || "0",
          }))
        );
  ...
  const handleCurrentDateCheckBox1 = (e) => {
    const isChecked = e.target.checked;
  ...
  const handleSelectDateCheckBox = (e, index) => {
    ...
    setContainerData((prevState) => {
      ...
      // Check if all are 'Y' after the update
      const allChecked = updatedData.every((item) => item.checkDate === "Y");
      setCheckInvDate(allChecked ? "Y" : "N");
  ...
  const handleSelectInvDate = (date, index) => {
    setContainerData((prevState) => {
      ...
      const gateInDate = updatedData[index]?.gateInDate
        ? new Date(updatedData[index].gateInDate)
        : null;
      const lastInvoiceDate = updatedData[index]?.lastInvoiceUptoDate
        ? new Date(updatedData[index].lastInvoiceUptoDate)
        : null;
  ...
  const handleSave = () => {
    ...
    axios
      .post(
        `${ipaddress}assessmentgeneral/saveContainerWiseGeneralReceivingAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`,
        // `${ipaddress}assessment/saveContainerWiseGeneralReceivingAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
      ...
      .then((response) => {
        ...
        console.log("gateoutassessmentData ", data.ga);
        ...
        setAssessmentData({
          ...
          impAddress: singleData[19]
            ? singleData[19] + " - " + singleData[20] + " - " + singleData[21]
            : "",
          impGst: singleData[22] || "",
          chaAddress: singleData[32]
            ? singleData[32] + " - " + singleData[33] + " - " + singleData[34]
            : "",
          ...
          creditAllowed:
            singleData[51] === "Y" ? response.data.creditAllowed : "",
          saId: singleData[17] || "",
          slId: singleData[15] || "",
          lastAssesmentId: singleData[75] || "",
          lastAssesmentDate:
            singleData[76] === null ? null : new Date(singleData[76]),
          lastInvoiceNo: singleData[77] || "",
          lastInvoiceDate:
            singleData[78] === null ? null : new Date(singleData[78]),
        });
        ...
        setContainerData(
          data.map((item) => ({
            ...
            assesmentLineNo: item[1] || "",
            containerNo: item[58] || "",
            containerSize: item[63] || "",
            containerType: item[64] || "",
            gateInDate: item[65] === null ? null : new Date(item[65]),
            destuffDate: null,
            gateoutDate: item[66] === null ? null : new Date(item[66]),
            examPercentage: item[59] || "",
            typeOfContainer: "",
            scannerType: "",
            gateOutType: item[67] || "",
            checkDate: "Y",
  ...
  const handleSave1 = () => {
    console.log("DEBUG - chaGst value:", assessmentData.chaGst);
    console.log("DEBUG - chaGst type:", typeof assessmentData.chaGst);
    console.log("DEBUG - chaGst length:", assessmentData.chaGst?.length);

    console.log("DEBUG - impGst value:", assessmentData.impGst);
    console.log("DEBUG - impGst type:", typeof assessmentData.impGst);
    console.log("DEBUG - impGst length:", assessmentData.impGst?.length);
    if (!assessmentData.igmTransId) {
      toast.error("Job data not found", {
        autoClose: 800,
      });
    ...
    if (!assessmentData.billingParty) {
      ...
      console.log("assessmentData.billingParty", assessmentData.billingParty);
    ...
    const findNullInvDate = containerData.filter(
      (item) => item.invoiceDate === null
    );
    ...
    axios
      .post(
        `${ipaddress}assessmentgeneral/saveGeneralContWiseDeliveryAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`,
        // `${ipaddress}assessment/saveGeneralContWiseDeliveryAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
      ...
      .then((response) => {
        ...
        setContainerData(
          data.map((item) => ({
            ...
            containerSize: item[63] || "",
            containerType: item[64] || "",
            gateInDate: item[66] === null ? null : new Date(item[66]),
            destuffDate: null,
            gateoutDate: null,
            examPercentage: item[59] || "",
            typeOfContainer: "",
            ...
            checkDate: "Y",
            invoiceDate: item[68] === null ? null : new Date(item[68]),
            lastInvoiceUptoDate: item[65] === null ? null : new Date(item[65]),
            upTariffNo: "",
            profitcentreId: "",
            grossWt: item[61] || "",
            cargoWt: item[60] || "",
  ...
  const getTds = (val) => {
    ...
    axios
      .get(
        `${ipaddress}assessmentgeneral/getTdsPerc?cid=${companyid}&bid=${branchId}&val=${val}`,
        // `${ipaddress}assessment/getTdsPerc?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
    ...
    if (name === "payMode") {
      if (tdsPerc === "") {
        if (tdsPerc === "" && value !== "TDS") {
          ...
          setBalanceAmt(
            roundToThree(balanceAmt - amt) < 0
              ? 0
              : roundToThree(balanceAmt - amt)
          );
  ...
  const saveProcess = () => {
    for (let i = 0; i < paymentMode.length; i++) {
      ...
      if (
        ...
        toast.error(
          `Error: Cheque details are missing for payment mode entry ${i + 1}.`,
          {
            autoClose: 800,
          }
        );
      ...
      if (!amount) {
        toast.error(
          `Error: Amount is required for payment mode entry ${i + 1}.`,
          {
            autoClose: 800,
          }
        );
    ...
    if (assessmentData.creditType === "Y") {
      ...
      const creditAmt = creditRed.reduce(
    ...
    if (assessmentData.creditType === "P") {
      const creditRed = paymentMode.filter(
        (item) => item.payMode === "ADVANCE"
      );
      ...
      if (advanceAmt < creditAmt) {
        toast.error(
          `The advance amount exceeds the remaining advance balance of the billing party.`,
          {
            autoClose: 800,
          }
        );
    ...
    axios
      .post(
        `${ipaddress}assessmentgeneral/saveContainerWiseGeneralJobInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`,
        // `${ipaddress}assessment/saveContainerWiseGeneralJobInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
      ...
      .then((response) => {
        ...
        setAssessmentData({
          ...
          isAncillary: singleData[53] || "N",
          invoiceDate:
            singleData[54] === null ? null : new Date(singleData[54]),
          irn: singleData[55] || "",
        ...
        setPaymentMode(
          payData.map((item) => ({
            ...
            chequeDate:
              item.chequeDate === null ? null : new Date(item.chequeDate),
  ...
  const saveProcess1 = () => {
    ...
    axios
      .post(
        `${ipaddress}assessmentgeneral/saveGeneralContWiseDeliveryInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`,
        // `${ipaddress}assessment/saveGeneralContWiseDeliveryInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
  ...
  const [isModalOpenForSearchGateInData, setIsModalOpenForGateInData] =
    useState(false);
  ...
  const searchExportEmptyContainerGateIn = (id) => {
    ...
    axios
      .get(
        `${ipaddress}assessmentgeneral/searchGeneralConInvoiceData?cid=${companyid}&bid=${branchId}&val=${id}&type=${selectedInvoice}`,
        // `${ipaddress}assessment/searchGeneralConInvoiceData?cid=${companyid}&bid=${branchId}&val=${id}&type=${selectedInvoice}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const getSelectedInvoiceData = (assId, invId) => {
    axios
      .get(
        `${ipaddress}assessmentgeneral/getSelectedGeneralConInvoiceData?cid=${companyid}&bid=${branchId}&assId=${assId}&invId=${invId}&type=${selectedInvoice}`,
        // `${ipaddress}assessment/getSelectedGeneralConInvoiceData?cid=${companyid}&bid=${branchId}&assId=${assId}&invId=${invId}&type=${selectedInvoice}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
        ...
        if (selectedInvoice === "noc") {
          setContainerData(
            data.map((item) => ({
              ...
              invoiceDate: item[68] === null ? null : new Date(item[68]),
              lastInvoiceUptoDate:
                item[79] === null ? null : new Date(item[79]),
              upTariffNo: "",
              profitcentreId: "",
              grossWt: item[61] || "",
              cargoWt: item[60] || "",
          ...
          setContainerData(
            data.map((item) => ({
              ...
              invoiceDate: item[68] === null ? null : new Date(item[68]),
              lastInvoiceUptoDate:
                item[65] === null ? null : new Date(item[65]),
              upTariffNo: "",
              profitcentreId: "",
              grossWt: item[61] || "",
              cargoWt: item[60] || "",
  ...
  const currentItems = gateInSearchData.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  const getExBoeSearchData = (val) => {
    ...
    axios
      .get(
        `${ipaddress}assessmentgeneral/getBeforeAssessmentConWiseDeliveryData?cid=${companyid}&bid=${branchId}&val=${val}`,
        // `${ipaddress}assessment/getBeforeAssessmentConWiseDeliveryData?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
  ...
  const handleExBondBoeSearchChange = async (selectedOption, { action }) => {
    if (action === "clear") {
      ...
      getSelectedBeforeSearchDataForExBond(selectedOption.deliveryId);
    }
  };
  ...
  const getSelectedBeforeSearchDataForExBond = (val) => {
    ...
    axios
      .get(
        `${ipaddress}assessmentgeneral/getGeneralConDeliveryBeforeSaveAssessmentData?cid=${companyid}&bid=${branchId}&val=${val}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
      ...
      .then((response) => {
        ...
        setContainerData(
          data.map((item) => ({
            ...
            gateInDate: item[23] === null ? null : new Date(item[23]),
            destuffDate: null,
            gateoutDate: null,
            examPercentage: item[18] || "0",
            typeOfContainer: "",
            scannerType: "",
            gateOutType: "",
            checkDate: "N",
            ...
            profitcentreId: item[1] || "",
            grossWt: item[22] ? (item[22] / 1000).toFixed(3) : "",
            cargoWt: parseFloat(item[21]).toFixed(3) || 0,
            ssrTransId: "",
            serviceId: "",
            serviceName: "",
            rates: "",
            containerStatus: item[16] || "",
            gatePassNo: "",
            gateOutId: "",
            area: parseFloat(item[21]).toFixed(3) || "0",
          }))
        );
  ...
  const [showModalforPrintInvoice, setShowModalforPrintInvoice] =
    useState(false);
  ...
  const [isModalOpenForAddService, setIsModalOpenForAddService] =
    useState(false);

  const getAllCfInvSrvAnxList = async (
    companyId,
    branchId,
    assesmentId,
    assesmentLineNo,
    ...
    try {
      const response = await FinanceService.getAllCfInvSrvAnxListForGeneral(
        companyId,
        branchId,
        assesmentId,
        assesmentLineNo,
  ...
  const currentItemsAddService = CfinvsrvanxData.slice(
    indexOfFirstItemAddService,
    indexOfLastItemAddService
  );
  ...
  const searchServices = async (searchvalue, containerSize, containerType) => {
    try {
      const response = await FinanceService.searchServicesForAddServiceForGeneral(
        companyid,
        branchId,
        searchvalue,
        assessmentData.commodityCode,
        containerSize,
        containerType,
        assessmentData,
        jwtToken
  ...
  const handleServiceChange = async (selectedOption, srlNo) => {
    ...
    setSelectedServices((prevServices) => {
      const existingService = prevServices.find(
        (service) => service.srlNo === srlNo
      );

      if (existingService) {
        // Update the existing service
        return prevServices.map(
          (service) =>
            service.srlNo === srlNo
  ...
  const handleFieldChangeService = async (
    e,
    fieldName,
    type,
    srlNo,
            ...
            updatedService.actualNoOfPackages = (
              ...
              parseFloat(
                updatedService.executionUnit1 &&
                  updatedService.serviceUnit1 !== "NA" &&
                  updatedService.serviceUnit1.trim() !== ""
                  ? updatedService.executionUnit1
                  : 1
              )
            ).toFixed(2);
  ...
  const saveAddService = async (serviceData) => {
    const filteredData =
      serviceData?.filter((detail) => detail.addServices === "Y") || [];
    ...
    setLoading(true);
    try {
      const response = await FinanceService.addServiceForGeneral(
        companyid,
        branchId,
        userId,
        assessmentData,
  ...
  const [
    isModalOpenForAddServiceServiceWise,
    setIsModalOpenForAddServiceServiceWise,
  ] = useState(false);
  ...
  const openModelForAddServiceServiceWise = async () => {
    ...
    await getAllContainerListOfAssessMentSheet(
      companyid,
      branchId,
  ...
  const getAllContainerListOfAssessMentSheet = async (
    companyId,
    branchId,
    assesmentId,
    profitcentreId
    ...
    try {
      const response =
        await FinanceService.getAllContainerListOfAssessMentSheetGeneral(
          companyId,
          branchId,
          assesmentId,
          profitcentreId,
  ...
  const getAllContainerDetailsOfAssesmentId = () => {
    try {
      ...
      axios
        .get(
          `${ipaddress}assessmentgeneral/getDataByAfterAssessmentForGeneralCon?cid=${companyid}&bid=${branchId}&id=${assessmentData.assesmentId}&partyId=${partyId}&creditType=${assessmentData.creditType}&type=${selectedInvoice}`,
          // `${ipaddress}assessment/getDataByAfterAssessmentForGeneralCon?cid=${companyid}&bid=${branchId}&id=${assessmentData.assesmentId}&partyId=${partyId}&creditType=${assessmentData.creditType}&type=${selectedInvoice}`,
          {
            headers: {
              Authorization: `Bearer ${jwtToken}`,
            },
          ...
          updatedContainer.actualNoOfPackages = (
            ...
            parseFloat(
              updatedContainer.executionUnit1 &&
                updatedContainer.serviceUnit1 !== "NA" &&
                updatedContainer.serviceUnit1.trim() !== ""
                ? updatedContainer.executionUnit1
                : 1
            )
          ).toFixed(2);
  ...
  useEffect(() => {
    setSelectedContainersAll(
      selectedContainers.length === containerDataServiceWise.length
    );
  ...
  const handleRowCheckboxChangeContainer = (index) => {
    ...
    if (selectedItemPartyOrCHA) {
      const selectedIndex = selectedContainers.findIndex(
        (item) => item.containerNo === selectedItemPartyOrCHA.containerNo
      );
  ...
  return (
    <div>
      ...
      <Modal
        Modal
        isOpen={isModalOpenForAddServiceServiceWise}
        onClose={handleClosAddServiceServiceWise}
        toggle={handleClosAddServiceServiceWise}
        style={{
          maxWidth: "1200px",
          fontSize: 14,
          wioverflow: "-moz-hidden-unscrollable",
                ...
                <Col md={2}>
                  <FormGroup>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleFieldChangeContainer(e, "executionUnit", "number")
                      }
                    />
                  </FormGroup>
                </Col>
                ...
                <Col md={2}>
                  <FormGroup>
                    ...
                    <input
                      ...
                      maxLength={7}
                      onChange={(e) =>
                        handleFieldChangeContainer(e, "rate", "number")
                      }
                    />
                  </FormGroup>
                </Col>
                      ...
                      <td>
                        <Input
                          ...
                          checked={selectedContainers.some(
                            (imports) =>
                              imports.containerNo === item.containerNo
                          )}
                          onChange={() =>
                            handleRowCheckboxChangeContainer(index)
                          }
                        />
                      </td>
                      <td>{index + 1}</td>
      ...
      <Modal
        Modal
        isOpen={isModalOpenForSearchGateInData}
        onClose={closeGateInModal}
        toggle={closeGateInModal}
        style={{
          maxWidth: "1200px",
          fontSize: 12,
          wioverflow: "-moz-hidden-unscrollable",
                  ...
                  <tr key={index}>
                    <td>
                      <input
                        type="radio"
                        onChange={() =>
                          getSelectedInvoiceData(item[1], item[0])
                        }
                        name="radioGroup"
                        value={item[0]}
                      />
        ...
        <Row>
          ...
          {selectedInvoice === "exbond" && (
            <Col md={4}>
              <FormGroup>
                <label className="forlabel bold-label" htmlFor="sbRequestId">
                  Search By  Delivery Id / Job No / BOE No
                  {/* Search By Container No / Delivery Id / Job No / BOE No */}
                </label>
                <Select
        ...
        <div>
          ...
          <Row>
            ...
            <Col md={2}>
              <FormGroup>
                <label className="forlabel bold-label" htmlFor="sbRequestId">
                  {selectedInvoice === "noc" ? "Receiving Id" : "Delivery Id"}
                </label>
                <input
                  className="form-control"
                  type="text"
          ...
          <Row>
            <Col md={2}>
              <FormGroup>
                ...
                <Select
                  value={{
                    value: assessmentData.importerId,
                    label: assessmentData.importerName,
                  }}
            ...
            <Col md={2}>
              <FormGroup>
                ...
                <Select
                  value={{
                    value: assessmentData.cha,
                    label: assessmentData.chaName,
                  }}
          ...
          <Row>
            <Col md={2}>
              <FormGroup>
                ...
                <Select
                  value={{
                    value: assessmentData.onAccountOf,
                    label: assessmentData.fwdName,
                  }}
            ...
            <Col md={2}>
              <FormGroup>
                ...
                <Select
                  value={{
                    value: assessmentData.othPartyId,
                    label: assessmentData.accHolderName,
                  }}
          ...
          <Row className="justify-content-center">
            ...
            >
              ...
              <button
                ...
                id="submitbtn2"
                disabled={
                  assessmentData.invoiceNo || !assessmentData.assesmentId
                }
                    ...
                    {assessmentData.assesmentId !== "" && (
                      <>
                        <th
                          scope="col"
                          className="text-center"
                          style={{ color: "black", minWidth: 300 }}
                        >
                          Service Name
                        </th>
                        <th
                          scope="col"
                          className="text-center"
                          style={{ color: "black", minWidth: 150 }}
                        >
                          Amount
                        </th>
                        <th
                ...
                <tbody className="text-center">
                  {containerData.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>{item.cargoWt}</td>
                      <td style={{ width: 130 }}>{item.grossWt}</td>
                      {/* <td style={{ width: 130 }}>
                                                {item.containerNo}
                                            </td> */}
                      ...
                      <td style={{ width: 180 }}>
                        <div style={{ position: "relative", width: 150 }}>
                          <DatePicker
                            ...
                            name="invoiceDate"
                            onChange={(date) =>
                              handleSelectInvDate(date, index)
                            }
                            dateFormat="dd/MM/yyyy HH:mm"
                            portalId="datepicker-portal15" // Add this line
                            minDate={(() => {
                              const date = new Date(
                                item.lastInvoiceUptoDate === null
                                  ? item.gateInDate
                                  : item.lastInvoiceUptoDate
                              );
                        ...
                        <>
                          ...
                          <td>
                            <button
                              ...
                              style={{ marginRight: 10, fontSize: 13 }}
                              id="submitbtn2"
                              onClick={() => openAddServiceModal(item)}
                            >
                      ...
                      <td style={{ width: 180 }}>
                        <div style={{ position: "relative", width: 150 }}>
                          <DatePicker
                            ...
                            name="invoiceDate"
                            onChange={(date) =>
                              handleSelectInvDate1(date, index)
                            }
                            dateFormat="dd/MM/yyyy HH:mm"
                            portalId="datepicker-portal15" // Add this line
                            minDate={(() => {
                      ...
                      <Row>
                        <Col md={8}>
                          ...
                          >
                            ...
                            {assessmentData.importerId !== "" && (
                              <option value="IMP">Importer</option>
                            )}
                            {assessmentData.onAccountOf !== "" && (
                              <option value="FWR">Forwarder</option>
                            )}
                            {assessmentData.othPartyId !== "" && (
                ...
                {tanNo !== "" && (
                  <Row>
                    <span style={{ color: "red" }}>
                      The TDS will be deducted as per the applicable TDS
                      percentage.
                    </span>
                  </Row>
                )}
                          ...
                          <tr>
                            ...
                            <td>
                              <Input
                                ...
                                disabled={assessmentData.invoiceNo !== ""}
                                onChange={(e) =>
                                  handlePaymentModeChange(e, index)
                                }
                                style={{ width: 150 }}
                              >
                                <option value=""></option>
                            ...
                            <td>
                              <div style={{ position: "relative", width: 210 }}>
                                <DatePicker
                                  ...
                                  } // Custom input element for styling
                            ...
                            <td className="text-center">
                              {item.status === "" ? (
                                <button
                                  ...
                                  id="submitbtn2"
                                  onClick={() =>
                                    removePaymentMode(index, item.amount)
                                  }
                                >
                                  <FontAwesomeIcon icon={faTrash} />
                                </button>
