...
export default function BondProforma({ activeTab }) {
    ...
    const getSearchData = (val) => {
        ...
        axios.get(`${ipaddress}assessment/searchBONDNOCBeforeSaveAssessmentData?cid=${companyid}&bid=${branchId}&val=${val}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handleSearchChange = async (selectedOption, { action }) => {
        ...
        if (action === 'clear') {
            ...
            getSelectedBeforeSearchData(selectedOption.nocTransId, selectedOption.value);
        }
    };
    ...
    const getSelectedBeforeSearchData = (igmtrans, igm) => {
        setLoading(true);
        axios.get(`${ipaddress}assessment/getBONDNOCBeforeSaveAssessmentData?cid=${companyid}&bid=${branchId}&trans=${igmtrans}&boe=${igm}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                ...
                setAssessmentData({
                    ...
                    commodityDescription: singleData[21] || "",
                    commodityCode: "",
                    ...
                    chaSrNo: singleData[16] === null ? '' : singleData[16] || '',
                    sez: "N",
                    taxApplicable: "Y",
                    onAccountOf: "",
                    accSrNo: "",
                    ...
                    chaGst: singleData[20] === null ? '' : singleData[20] || '',
                    fwdGst: "",
                    fwdName: "",
                    fwdState: "",
                    accHolderGst: "",
                    ...
                    saId: "",
                    slId: "",
                    lastAssesmentId: singleData[33] || '',
                    lastAssesmentDate: singleData[35] === null ? null : new Date(singleData[35]),
                    lastInvoiceNo: singleData[34] || '',
                    lastInvoiceDate: singleData[36] === null ? null : new Date(singleData[36]),
                ...
                setContainerData(data.map((item) => ({
                    ...
                    containerNo: item[25] || '',
                    containerSize: item[26] || '',
                    containerType: item[27] || '',
                    gateInDate: item[28] === null ? null : new Date(item[28]),
                    destuffDate: null,
                    gateoutDate: item[29] === null ? null : new Date(item[29]),
                    examPercentage: remainingNop || '',
                    typeOfContainer: '',
                    scannerType: '',
                    gateOutType: item[32] === null ? (item[30]) : null,
                    checkDate: 'N',
                    invoiceDate: item[32] === null ? (item[29] === null ? null : new Date(item[29])) : null,
                    lastInvoiceUptoDate: (item[32] === null || item[34] === null || item[34] === '') ? null : new Date(item[32]),
                    upTariffNo: "",
                    profitcentreId: item[1] || '',
                    grossWt: item[24] ? (item[24] / 1000).toFixed(3) : '',
                    cargoWt: finalArea || '',
                    ssrTransId: item[31] || '',
                    serviceId: "",
                    serviceName: "",
    ...
    const handleSave = () => {
        ...
        axios.post(`${ipaddress}proforma/saveBondNocAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handleSave1 = () => {
        ...
        axios.post(`${ipaddress}proforma/saveExbondAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const saveProcess = () => {
        ...
        axios.post(`${ipaddress}proforma/saveBondNocInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const saveProcess1 = () => {
        ...
        axios.post(`${ipaddress}proforma/saveExBondInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const searchExportEmptyContainerGateIn = (id) => {
        setLoading(true);
        axios.get(`${ipaddress}proforma/searchBondNOCInvoiceData?cid=${companyid}&bid=${branchId}&val=${id}&type=${selectedInvoice}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const getSelectedInvoiceData = (assId, invId) => {
        axios.get(`${ipaddress}proforma/getSelectedBondNOCInvoiceData?cid=${companyid}&bid=${branchId}&assId=${assId}&invId=${invId}&type=${selectedInvoice}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const getExBoeSearchData = (val) => {
        ...
        axios.get(`${ipaddress}assessment/searchExbondBeforeData?cid=${companyid}&bid=${branchId}&val=${val}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handlePrint1 = async (type) => {
        ...
        setLoading(true);
        axios.post(`${ipaddress}importinvoiceproformaprint/printBondNocInvoicepdf/${companyid}/${branchId}/${invoiceNo}/${assesmentId}/${igmTransId}/${selectedInvoice}`, {
            headers: {
    ...
    const getSelectedBeforeSearchDataForExBond = (val) => {
        setLoading(true);
        axios.get(`${ipaddress}assessment/getExbondBeforeSaveAssessmentData?cid=${companyid}&bid=${branchId}&val=${val}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
            .then((response) => {
                ...
                setAssessmentData({
                    ...
                    accSrNo: "",
                    comments: "",
                    othPartyId: singleData[22] === null ? '' : singleData[22] || "",
                    othSrNo: singleData[26] === null ? '' : singleData[26] || "",
                    billingParty: "",
                    invoiceNo: "",
                    creditType: "Y",
                    invoiceCategory: "SINGLE",
                    ...
                    fwdName: "",
                    fwdState: "",
                    accHolderGst: singleData[24] === null ? '' : singleData[24] || "",
                    accHolderName: singleData[23] === null ? '' : singleData[23] || "",
                    accHolderState: singleData[25] === null ? '' : singleData[25] || "",
                    creditAllowed: "",
                    saId: "",
                    slId: "",
                    lastAssesmentId: '',
                ...
                setContainerData(data.map((item) => ({
                    ...
                    assesmentLineNo: item[1] || '',
                    containerNo: item[30] || '',
                    containerSize: item[31] || '',
                    containerType: item[32] || '',
                    gateInDate: item[33] === null ? null : new Date(item[33]),
                    destuffDate: null,
                    gateoutDate: null,
                    examPercentage: item[27] || '',
                    typeOfContainer: '',
                    scannerType: '',
                    gateOutType: '',
                    checkDate: 'N',
                    invoiceDate: null,
                    lastInvoiceUptoDate: item[33] === null ? null : new Date(new Date(item[33]).setDate(new Date(item[33]).getDate() + 1)),
                    upTariffNo: "",
                    profitcentreId: item[1] || '',
                    grossWt: item[29] ? (item[29] / 1000).toFixed(3) : '',
                    cargoWt: item[28] || '',
                    ssrTransId: item[34] || '',
                    serviceId: "",
                    serviceName: "",
    ...
    const getAllContainerDetailsOfAssesmentId = () => {
        try {
            ...
            axios.get(`${ipaddress}proforma/getDataByAfterAssessmentForBond?cid=${companyid}&bid=${branchId}&id=${assessmentData.assesmentId}&partyId=${partyId}&creditType=${assessmentData.creditType}&type=${selectedInvoice}`, {
                headers: {
                    Authorization: `Bearer ${jwtToken}`
                }
            })
    ...
    const saveAddServiceContainerWise = async (selectedContainers) => {
        ...
        try {
            const response = await FinanceService.addServiceExportInvoiceServiceWise3(companyid, branchId, userId, assessmentData, Cfinvsrvanx, jwtToken, selectedInvoice);
                ...
                <ModalBody style={{ backgroundImage: 'url(https://img.freepik.com/free-vector/gradient-wavy-background_23-2149123392.jpg?t=st=1694859409~exp=1694860009~hmac=b397945a9c2d45405ac64956165f76bd10a0eff99334c52cd4c88d4162aad58e)', backgroundSize: 'cover' }} >
                    <Row>
                        <Col md={5}>
                            <FormGroup>
                                <label className="forlabel bold-label" htmlFor="sbRequestId">
                                    Search by Invoice No / Assessment Id / NOC trans Id / NOC No / BOE No
                                </label>
                                <input
                                    className="form-control"
                                    type="text"
                ...
                <div>
                    ...
                    <Row>
                        ...
                        <Col md={2}>
                            <FormGroup>
                                <label className="forlabel bold-label" htmlFor="sbRequestId">
                                    NOC Trans Id <span style={{ color: 'red' }}>*</span>
                                </label>
                                <input
                                    className="form-control"
                                    type="text"
                    ...
                    <Row>
                        <Col md={2}>
                            <FormGroup>
                                <label className="forlabel bold-label" htmlFor="sbRequestId">
                                    NOC NO <span style={{ color: 'red' }}>*</span>
                                </label>
                                <input
                                    className="form-control"
                                    type="text"
                                            ...
                                            <td style={{ width: 180 }}>
                                                <div style={{ position: 'relative', width: 150 }}>
                                                    <DatePicker
                                                        ...
                                                        dateFormat="dd/MM/yyyy HH:mm"
                                                        portalId="datepicker-portal1" // Add this line
