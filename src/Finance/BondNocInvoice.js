...
export default function BondNocInvoice({ activeTab }) {
    ...
    const handleSave = () => {
        ...
        axios.post(`${ipaddress}assessment/saveBondNocAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handleSave1 = () => {
        ...
        axios.post(`${ipaddress}assessment/saveExbondAssessmentData?cid=${companyid}&bid=${branchId}&user=${userId}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const saveProcess = () => {
        ...
        axios.post(`${ipaddress}assessment/saveBondNocInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const saveProcess1 = () => {
        ...
        axios.post(`${ipaddress}assessment/saveExBondInvoiceReceipt?cid=${companyid}&bid=${branchId}&user=${userId}&creditStatus=${assessmentData.creditType}`, formData, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const searchExportEmptyContainerGateIn = (id) => {
        setLoading(true);
        axios.get(`${ipaddress}assessment/searchBondNOCInvoiceData?cid=${companyid}&bid=${branchId}&val=${id}&type=${selectedInvoice}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
    ...
    const handlePrint1 = async (type) => {
        ...
        axios.post(`${ipaddress}importinvoiceprint/printBondNocInvoicepdf/${companyid}/${branchId}/${invoiceNo}/${assesmentId}/${igmTransId}/${selectedInvoice}`, {
            headers: {
    ...
    const saveAddServiceContainerWise = async (selectedContainers) => {
        ...
        try {
            const response = await FinanceService.addServiceExportInvoiceServiceWise2(companyid, branchId, userId, assessmentData, Cfinvsrvanx, jwtToken, selectedInvoice);
