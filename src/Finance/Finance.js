...
import ImportGateOut from '../Parent Pages/ImportGateOut';
import {
    Row,
    Col,
    Input,
...
import { faIdBadge, faChartGantt, faBold, faBox, faArrowAltCircleLeft, faSearch, faRefresh, faUpload, faFileExcel, faSave, faCheck, faDownload, faTrash, faCalendarAlt, faAdd, faChevronUp, faChevronDown, faBuildingColumns } from '@fortawesome/free-solid-svg-icons';
import '../assets/css/style.css';
import '../Components/Style.css';
import useAxios from '../Components/useAxios';
import ImportInvoice1 from './ImportInvoice1';
import BondNocInvoice from './BondNocInvoice';
import ARReceipts from './ARReceipts';
import ExportInvoice from './ExportInvoice';
import MiscellaneousInvoice from './MiscellaneousInvoice';
...
import GeneralPeriodiCommodityWiseInvoice from './GeneralPeriodiCommodityWiseInvoice';
                ...
                <Card style={{ backgroundColor: "#F8F8F8" }}>
                    <CardBody>
                        ...
                        <div className="tab-content bgScreenStyle" id="borderedTabJustifiedContent">
                            <div className={`tab-pane fade ${activeTab === 'P01101' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <ImportInvoice1 activeTab={activeTab} />

                            </div>
                            <div className={`tab-pane fade ${activeTab === 'P01102' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <BondNocInvoice activeTab={activeTab} />

                            </div>

                            <div className="tab-content pt-2" id="borderedTabJustifiedContent">
                                <div className={`tab-pane fade ${activeTab === 'P01103' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="3">

                                    <ExportInvoice activeTab={activeTab} />

                                </div>
                            </div>

                            <div className={`tab-pane fade ${activeTab === 'P01104' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <ARReceipts activeTab={activeTab} />

                            </div>
                            <div className={`tab-pane fade ${activeTab === 'P01109' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <MiscellaneousInvoice activeTab={activeTab} />
                            </div>
                            <div className={`tab-pane fade ${activeTab === 'P01111' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <AuctionInvoice activeTab={activeTab} />
                            </div>
                            <div className={`tab-pane fade ${activeTab === 'P01112' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <GeneralInvoice activeTab={activeTab} />
                            </div>
                            <div className={`tab-pane fade ${activeTab === 'P01113' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <GeneralContainerInvoice activeTab={activeTab} />
                            </div>
                            ...
                            <div className={`tab-pane fade ${activeTab === 'P01116' ? 'show active' : ''}`} id="bordered-justified-home-1" role="tabpanel" aria-labelledby="1">

                                <GeneralPeriodiCommodityWiseInvoice activeTab={activeTab} />
                            </div>
                        </div>
                    </CardBody>
                </Card>
