  ...
  return (
    <>
      ...
      <div>
        ...
        <hr />
<div id="datepicker-portal21"></div>
        <div
          className="table-responsive"
          style={{ maxHeight: "400px", overflowY: "auto" }}
        >
...
<td >
  <FormGroup >
    ...
    <div  style={{ position: "relative", width: 150 }}>
      <DatePicker
        selected={rowData.boeDate ? new Date(rowData.boeDate) : null}
        onChange={(date) => {
          const updatedRows = [...rows];
          updatedRows[index].boeDate = date;
          setRows(updatedRows);
        }}
        id={`boeDate_${index}`}
        name="boeDate"
         portalId="datepicker-portal21" 
                      dateFormat="dd/MM/yyyy HH:mm"
                      showTimeInput
       timeFormat="HH:mm"
                    className="form-control border-right-0 InputField"
  ...
  <FormGroup>
    <Input
      type="text"
       maxLength="11"
      value={rowData.containerNo}
      onChange={(e) => handleTextChange(index, "containerNo", e)}
      className={`form-control ${errors.containerNo && errors.containerNo[index] ? "is-invalid" : ""}`}
      style={{ width: "180px" }}
    />
    {errors.containerNo && errors.containerNo[index] && (
      <FormFeedback style={{ color: "red" }}>
        {errors.containerNo[index]}
      </FormFeedback>
    )}
  </FormGroup>
</td>
